...
//			    rows += "\n";
			...
			Rel = Variables.convertStringListToIntegerList(RelString);
	...
	/**
	 * Method to create the Network Database (Nodes and Relationships)
	 * @param Name1 ArrayList of Strings which will be used to create the Nodes
	 * @param Rel ArrayList of Integers 
	 * @param Name2 ArrayList of Strings
	 * @param neo4jDbpath String value for the Database Path. Example: "C:/Users/User/Documents/Neo4j/eclipse"
	 * @param networkIdentifier Integer value to identify if the database is Module or Commiters Network. Example: 0 - Module Network, 1 - Commiters Network
	 */
